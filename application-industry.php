...
/**
 * Template Name: Application Industry
 *
 * */
get_header();
?>
			...
			<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-9 use-description">
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-5 use-info">
						...
						<p class="use-info-text">Это совершенно новый класс индустриальных двусторонних клейких лент.  Теперь возможно обеспечивать надежное и долговременное крепление материалов в самых сложных условиях.</p>
					</div>
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 use-product">
						...
						<a class="use-link" href="http://mustang.sportquest.com.ua/2019/09/03/%d0%b0%d1%80%d0%bc%d0%b8%d1%80%d0%be%d0%b2%d0%b0%d0%bd%d0%bd%d0%b0%d1%8f-%d0%ba%d0%bb%d0%b5%d0%b9%d0%ba%d0%b0%d1%8f-%d0%bb%d0%b5%d0%bd%d1%82%d0%b0/">
				...
				<div class="row">
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-5 use-info">
						...
						<p class="use-info-text">Двухсторонний скотч на тканевой основе пригоден для склеивания изделий из стекла, бумаги, картона, дерева, пластмассы и используется во многих отраслях промышленности, а также в быту:</p>
						<ul class="use-info-list">
							<li>в полиграфии, строительстве, машиностроении, швейном производстве, автомобилестроении;</li>
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-5 use-info">
						...
						<p class="use-info-text">Необходимость купить изоленту ПВХ прежде всего возникает в случаях проведения различных инженерно-технических работ:</p>
						<ul class="use-info-list">
							<li>Пластиков;</li>
							<li>Металлов;</li>
							<li>Стекла;</li>
							<li>Керамики;</li>
							<li>для предотвращения коротких замыканий и случайного прикосновения людей в ходе электроремонтных и электромонтажных работ;</li>
							<li>для соединения кабельно-проводниковых изделий в процессе изготовления автомобилей, электроники и другой продукции;</li>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-5 use-info">
						...
						<p class="use-info-text">В нашей компании вы можете цветной скотч купить и использовать его в следующих целях:</p>
						<ul class="use-info-list">
							...
							<li>для организации учета различных изделий по наименованиям и типам на производстве и складах, в магазинах и офисах;</li>
