...
<main>
	<div class="container-fluid distributors">
		<div class="row">
			<a class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 distributors-item d-flex justify-content-around align-items-center flex-column text-center" href="<?php echo home_url(); ?>/wp-content/uploads/2019/11/catalog-mustang.pdf">
			...
			<a class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 distributors-item d-flex justify-content-around align-items-center flex-column text-center" href="<?php echo home_url(); ?>/souvenirs/">
			...
			<a class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 distributors-item d-flex justify-content-around align-items-center flex-column text-center" href="<?php echo home_url(); ?>/trading-equipment/">
				<img src="<?php echo get_template_directory_uri(); ?>/img/distributors/equipment.png" alt="" class="distributors-img">
				<img src="<?php echo get_template_directory_uri(); ?>/img/distributors/equipment.png" class="distributors-img-hover" />
				<h6 class="distributors-title">
					Торговое <br> оборудование
				</h6>
			</a>
			<a class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 distributors-item d-flex justify-content-around align-items-center flex-column text-center" href="<?php echo home_url(); ?>/sales">
