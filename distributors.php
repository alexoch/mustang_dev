	...
	<div class="container-fluid distributors">
		<div class="row">
			...
			<a class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 distributors-item d-flex justify-content-around align-items-center flex-column text-center" href="http://mustang.sportquest.com.ua/souvenirs/">
				<img src="http://mustang.sportquest.com.ua/wp-content/themes/mustang/img/distributors/souvenir.png" alt="" class="distributors-img">
				<img src="http://mustang.sportquest.com.ua/wp-content/themes/mustang/img/distributors/souvenir.png" class="distributors-img-hover" />
				<h6 class="distributors-title">
			...
			<a class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 distributors-item d-flex justify-content-around align-items-center flex-column text-center" href="http://mustang.sportquest.com.ua/trading-equipment/">
				<img src="http://mustang.sportquest.com.ua/wp-content/themes/mustang/img/distributors/equipment.png" alt="" class="distributors-img">
				<img src="http://mustang.sportquest.com.ua/wp-content/themes/mustang/img/distributors/equipment.png" class="distributors-img-hover" />
				<h6 class="distributors-title">
			...
			<a class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-3 distributors-item d-flex justify-content-around align-items-center flex-column text-center" href="http://mustang.sportquest.com.ua/sales">
				<img src="http://mustang.sportquest.com.ua/wp-content/themes/mustang/img/distributors/stock.png" alt="" class="distributors-img-hover" />
                <img src="http://mustang.sportquest.com.ua/wp-content/themes/mustang/img/distributors/stock.png" alt="" class="distributors-img" />
                <h6 class="distributors-title">
					Акции
				</h6>
			</a>
